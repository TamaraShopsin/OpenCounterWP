	...
	var Thinbox = function(element,options) {
		...
		this.showModal = function(element,url) {
			...
			if(href.substr(0,1)=="#") {
				...
				var thinboxContent = $("<div style='height:100%;width:100%;background-color:#fff;'><div style='width:100%;padding:4px;background-color:#ddd;text-align:left;'>BETA VERSION<input type='button' value='X' onclick='ThinBox.remove()' style='float:right;margin-right:30px;'/></div><br/><br/><div style='padding:20px;'>OpenCounter is in beta<br/><br/>Try it out!</div></div>");
